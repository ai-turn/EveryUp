            ...
            <div className="flex items-start gap-3 mb-3">
              ...
              <div className="flex-1 min-w-0">
                <div className="flex items-center gap-1.5 flex-wrap">
                  ...
                  <span className={`px-1.5 py-0.5 text-[10px] font-bold uppercase tracking-wider rounded ${style.bg} ${style.text}`}>
                    {getChannelTypeLabel(channel.type, t)}
                  </span>
                  {!channel.isEnabled && (
                    <span className="px-1.5 py-0.5 text-[10px] font-bold uppercase tracking-wider bg-slate-100 dark:bg-ui-hover-dark text-slate-500 dark:text-text-muted-dark rounded">
                      {t('common.disabled')}
                    </span>
                  )}
                </div>
                <div className="text-[11px] text-slate-500 dark:text-text-muted-dark mt-0.5">
                  {lastSent
