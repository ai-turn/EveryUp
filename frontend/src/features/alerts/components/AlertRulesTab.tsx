    ...
    <>
      ...
      <div className="flex flex-wrap items-center gap-2 mb-3">
        ...
        <select
          ...
          className="px-2 py-1.5 bg-white dark:bg-bg-surface-dark border border-slate-200 dark:border-ui-border-dark rounded-md text-xs font-medium text-slate-700 dark:text-text-muted-dark cursor-pointer"
        >
        ...
        <div className="ml-auto relative w-64">
          ...
          <input
            ...
            className="w-full pl-7 pr-7 py-1.5 bg-white dark:bg-bg-surface-dark border border-slate-200 dark:border-ui-border-dark rounded-md text-xs outline-none focus:ring-1 focus:ring-primary dark:text-white"
          />
          {searchQuery && (
            <button
