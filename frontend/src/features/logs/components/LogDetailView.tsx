...
function TabContent({
  ...
  onApiKeyRegenerated,
  onGoToEdit,
}: Pick<LogDetailViewProps, 'activeTab' | 'service' | 'serviceId' | 'refreshKey' | 'onApiKeyRegenerated'> & { onGoToEdit: () => void }) {
  return (
    <>
    ...
    <div className="space-y-4">
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            onClick={() => navigate(`/logs/${serviceId}/edit`)}
            className="p-2.5 rounded-lg bg-primary/10 text-primary active:scale-95 transition-transform cursor-pointer"
          >
            <MaterialIcon name="edit" className="text-lg" />
          </button>
          <button
            onClick={onDeleteDialogOpen}
            className="p-2.5 rounded-lg bg-red-500/10 text-red-500 active:scale-95 transition-transform cursor-pointer"
          >
            <MaterialIcon name="delete" className="text-lg" />
          </button>
        </div>
