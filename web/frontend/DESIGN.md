...
**쓸 수 있는 굵기 클래스는 ·· 셋뿐이다.** Spoqa Han Sans Neo가 가진 굵기가 100/300/400/500/700이라 그 밖의 값은 브라우저가 가짜 볼드를 합성한다. 실제로 `font-extrabold`(800)가 KPI 수치 6곳에 남아 합성되고 있었고 제거했다. 새 굵기 유틸리티를 쓰기 전에 폰트에 그 굵기가 있는지 먼저 확인할 것.
