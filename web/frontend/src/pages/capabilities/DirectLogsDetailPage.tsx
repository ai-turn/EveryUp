...
export function DirectLogsDetailPage() {
  ...
  return (
    <div>
      <PageHeader title={service.name} subtitle={t('Agent 없이 연결된 OpenTelemetry 로그 서비스입니다.')}>
      ...
      <div className="mb-6 grid grid-cols-1 gap-4 lg:grid-cols-3">
        ...
        <section className="rounded-xl border border-ui-border bg-bg-surface p-5">
          ...
          <p className="mt-1 text-xs text-text-muted">{t('직접 서비스는 Agent와 독립적으로 Project에 배정됩니다.')}</p>
