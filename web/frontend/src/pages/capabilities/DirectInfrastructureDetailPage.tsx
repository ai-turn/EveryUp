      ...
      <div className="mb-6 grid grid-cols-1 gap-4 lg:grid-cols-3">
        <section className="rounded-xl border border-ui-border bg-bg-surface p-5 lg:col-span-2">
          <div className="flex flex-wrap items-start justify-between gap-3">
            <h2 className="text-base font-bold text-text-base">{t('Collector 연결')}</h2>
          ...
          <div className="mt-4 flex flex-wrap items-center gap-3 rounded-lg bg-ui-hover-soft p-3">
            <div className="min-w-0 flex-1">
              ...
              <p className="mt-1 truncate font-mono text-sm font-semibold text-text-secondary">{resource.apiKeyMasked || t('마스킹된 키 없음')}</p>
            </div>
