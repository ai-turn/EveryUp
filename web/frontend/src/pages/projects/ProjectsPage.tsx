  ...
  return (
    ...
    >
      <form onSubmit={submit}>
        ...
        <div className="flex justify-end gap-2 border-t border-ui-border px-6 py-4"><Button type="button" variant="secondary" onClick={onClose} disabled={saving}>취소</Button><Button type="submit" disabled={saving}>{project ? '저장' : '추가하기'}</Button></div>
      </form>
    </dialog>
  );
}
